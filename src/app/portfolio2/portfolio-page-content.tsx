...
const LazyCaseStudySection = dynamic(
  () => import("@/components/sections/Portfolio2/CaseStudySection"),
  { 
    loading: () => (
      <div className="flex items-center justify-center py-20">
        <div className="w-8 h-8 border-2 border-purple-500 border-t-transparent rounded-full animate-spin" />
...
const LazyAccordionFAQ = dynamic(
  () => import("@/components/ui/portfolio2/ui/accordion-faq").then(mod => ({ default: mod.AccordionFAQ })),
  { 
    loading: () => (
      <div className="flex items-center justify-center py-20">
        <div className="w-8 h-8 border-2 border-purple-500 border-t-transparent rounded-full animate-spin" />
      ...
      <section className="py-20 bg-gradient-to-b from-black to-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            ...
            className="bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-700 rounded-3xl p-8 md:p-12"
          >
