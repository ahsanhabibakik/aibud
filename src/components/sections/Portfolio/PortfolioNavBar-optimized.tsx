  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex fixed top-10 inset-x-0 mx-auto border border-white/20 rounded-full bg-black/95 backdrop-blur-xl shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-5000 pr-2 pl-4 sm:pl-8 py-2 items-center justify-center w-2/3 max-w-6xl min-w-fit"
        )}
        style={{
      ...
      >
        ...
        <div className="hidden lg:flex items-center justify-between w-full">
          ...
          <a
            ...
            className="border text-sm font-medium relative border-white/20 text-white px-4 py-2 rounded-full ml-auto hover:bg-white/10 transition-colors"
          >
