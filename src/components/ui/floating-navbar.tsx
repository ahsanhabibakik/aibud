  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed top-10 inset-x-0 mx-auto border border-white/20 rounded-full bg-black shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-5000 pr-2 pl-4 sm:pl-8 py-2 items-center justify-center",
          className
        )}
      >
        ...
        {secondaryNavItems.length > 0 && (
          <div className="md:hidden">
            ...
            {mobileMenuOpen && (
              <div className="absolute top-full right-0 mt-2 p-2 bg-black rounded-lg border border-white/20 flex flex-col min-w-[200px]">
        ...
        <a
          ...
          className="border text-xs sm:text-sm font-medium relative border-white/20 text-white px-3 py-1 sm:px-4 sm:py-2 rounded-full ml-auto hover:bg-white/10 transition-colors"
        >
          <span>{ctaText}</span>
